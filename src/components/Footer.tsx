...
const Footer = () => {
  return (
    <footer className="bg-darkBlue text-white px-20 py-10 flex flex-col lg:flex-row justify-between items-center">
      <section
        id="socialMedia"
      ...
      <section className="my-10 lg:my-0">
        <ul className="flex flex-col gap-y-2 lg:block columns-1 text-center lg:columns-2 lg:text-left text-grayBlue">
          <li className="hover:text-green cursor-pointer">About Use</li>
          <li className="hover:text-green cursor-pointer">Contact</li>
          <li className="hover:text-green cursor-pointer">Blog</li>
          <li className="hover:text-green cursor-pointer">Careers</li>
          <li className="hover:text-green cursor-pointer">Support</li>
          <li className="hover:text-green cursor-pointer">Privacy Policy</li>
        </ul>
      </section>
      <section className="w-fit min-h-[75px] flex flex-col justify-between items-center">
        ...
        <p className="text-grayBlue text-center mt-4 lg:mt-0">
